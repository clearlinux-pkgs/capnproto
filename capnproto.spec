...
Requires: capnproto = %{version}-%{release}
...
%prep
%setup -q -n capnproto-c++-0.8.0
cd %{_builddir}/capnproto-c++-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604539048
...
cp %{_builddir}/capnproto-c++-0.8.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/capnproto/64cbc092366604a5d208313503562c72b31671db
%make_install
...
/usr/lib64/libcapnp-0.8.0.so
/usr/lib64/libcapnp-json-0.8.0.so
/usr/lib64/libcapnp-json.so
/usr/lib64/libcapnp-rpc-0.8.0.so
/usr/lib64/libcapnp-rpc.so
/usr/lib64/libcapnp.so
/usr/lib64/libcapnpc-0.8.0.so
/usr/lib64/libcapnpc.so
/usr/lib64/libkj-0.8.0.so
/usr/lib64/libkj-async-0.8.0.so
/usr/lib64/libkj-async.so
/usr/lib64/libkj-gzip-0.8.0.so
/usr/lib64/libkj-gzip.so
/usr/lib64/libkj-http-0.8.0.so
/usr/lib64/libkj-http.so
/usr/lib64/libkj-test-0.8.0.so
/usr/lib64/libkj-test.so
/usr/lib64/libkj-tls-0.8.0.so
...
/usr/lib64/pkgconfig/kj-gzip.pc
/usr/lib64/pkgconfig/kj-http.pc
/usr/lib64/pkgconfig/kj-test.pc
/usr/lib64/pkgconfig/kj-tls.pc
/usr/lib64/pkgconfig/kj.pc

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/capnproto/64cbc092366604a5d208313503562c72b31671db
